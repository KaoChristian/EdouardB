...
class AdminSectionController extends AbstractController
{
    ...
    {
        return $this->render('admin/admin_section/index.html.twig', [
    ...
    public function new(Request $request, SectionRepository $sectionRepository): Response
    {
        ...
        return $this->renderForm('admin/admin_section/new.html.twig', [
            'section' => $section,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/admin_section/show.html.twig', [
            'section' => $section,
        ]);
    }
    ...
    public function edit(Request $request, Section $section, SectionRepository $sectionRepository): Response
    {
        ...
        return $this->renderForm('admin/admin_section/edit.html.twig', [
            'section' => $section,
            'form' => $form,
        ]);
    }
